...
const { check_query_text, check_language, get_headers, sleep } = require('./common');
...
const baidu_api = async (query_text, from_language = 'auto', to_language = 'en', kwargs = {}) => {
	...
	*/
	...
	const { use_domain = 'common', is_detail_result = false, timeout = null, proxies = null, sleep_seconds = parseInt(Math.random() * 10), if_ignore_limit_of_length = false } = kwargs;
